...
from dimension_magic import get_emg_and_glove_components,load_emg_data,get_glove_data,calculate_power_of_signal,custom_norm,fast_ica_analysis
...
class MyoKinFitter:
    def __init__(self,joint_angle,joint_signals,muscle_signals):
